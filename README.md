...
- vMix XML and all referenced media must remain unchanged for 30 seconds, pass three size/mtime probes, have a video-frame count within 100 frames or 3% of the XMEML declaration (whichever tolerance is greater), and successfully decode their final seconds before an import job is created.
